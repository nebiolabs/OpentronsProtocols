...
#Performs multiple RNAP misincorporation experiments (for single plate, use RNAP Single protocol) in sequence
#Place NTPs in first x rows, place enzyme in last x rows
#Will stop after 2 plates to prompt trash removal
